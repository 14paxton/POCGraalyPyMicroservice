import PipInstall.PackageName.OPENCV
import PipInstall.PackageName.PADDLEOCR
import PipInstall.PackageName.PADDLEPADDLE
import PipInstall.PackageName.PANDAS
import PipInstall.PackageName.SCIKIT_LEARN
import PipInstall.PackageName.SCIPY
import PipInstall.PackageName.SHAPELY
import PipInstall.PackageName.TIKTOKEN
...
val localPackageInstallPathList: Set<String> = PipInstall.resolvePackages(
  rootDir,
  listOf(
    PADDLEPADDLE,
    PADDLEOCR,
...
tasks.register<Copy>("copyVenvResources") {
  ...
  dependsOn("graalPyInstallPackages", cleanVenv)
...
tasks.named("graalPyInstallPackages") {
